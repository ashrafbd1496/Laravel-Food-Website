			...
			<div class="wrap-sidebar">
				...
				<div class="widget wid-about">
					...
					<div class="wid-content">
						<img src="{{asset('assets/images/15.jpg')}}"/>
				...
				<div class="widget wid-post">
					...
					<div class="wid-content">
						<div class="post">
							<a href="#"><img src="{{asset('assets/images/15.jpg')}}"/></a>
							<div class="wrapper">
						...
						<div class="post">
							<a href="#"><img src="{{asset('assets/images/14.jpg')}}"/></a>
							<div class="wrapper">
							  <h5><a href="#">Lorem ipsum dolor</a></h5>
							  <span>$25 - $26</span>
							</div>
						...
						<div class="post">
							<a href="#"><img src="{{asset('assets/images/13.jpg')}}"/></a>
							<div class="wrapper">
							  <h5><a href="#">Lorem ipsum dolor</a></h5>
							   <span>$25 - $26</span>
							</div>
				...
				<div class="widget wid-gallery">
					...
					<div class="wid-content">
						<a href="#"><img src="{{asset('assets/images/11.jpg')}}"></a>
						<a href="#"><img src="{{asset('assets/images/10.jpg')}}"></a>
						<a href="#"><img src="{{asset('assets/images/9.jpg')}}"></a>
						<a href="#"><img src="{{asset('assets/images/8.jpg')}}"></a>
						<a href="#"><img src="{{asset('assets/images/7.jpg')}}"></a>
						<a href="#"><img src="{{asset('assets/images/6.jpg')}}"></a>
					</div>
				</div>
			</div>
		</div>
